...
CoreDNS-001 has been [released](https://github.com/bhaswanth88/coredns/releases). This is the first
...
It chains [plugin](https://github.com/bhaswanth88/coredns/tree/master/plugin),
...
[faster](https://github.com/bhaswanth88/coredns/issues/184).

## New Plugins

* There is now a [specific
  plugin](https://github.com/bhaswanth88/coredns/tree/master/plugin/kubernetes) to deal with [Kubernetes](https://kubernetes.io).
* The *bind* [plugin](https://github.com/bhaswanth88/coredns/tree/master/plugin/bind)  allows you to bind to a specific IP address, instead of using the wildcard
  address.
* A *whoami* [plugin](https://github.com/bhaswanth88/coredns/tree/master/plugin/whoami) reports
...
If you want to help, please check out one of the [issues](https://github.com/bhaswanth88/coredns/issues/) and start coding!
