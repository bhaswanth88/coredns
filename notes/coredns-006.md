...
CoreDNS-006 has been [released](https://github.com/bhaswanth88/coredns/releases/tag/v006)!
...
Move CoreDNS to <https://github.com/bhaswanth88/coredns> together with several other repos. This will be
...
* *proxy* a new `protocol`: `grpc`: speak DNS over gRPC. Server side impl. resides [in this out of
  tree plugin](https://github.com/bhaswanth88/grpc).
